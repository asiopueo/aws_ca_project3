...
![base environment](images/AWS-WebServiceDiagram-v1-insecure.png)
...
![Expected AWS Console Status](images/cloudformation_status.png)
...
![Outputs Section](images/s3stack_output.png)
...
#### 1. Enable AWS Config (skip this step if you already have it enabled)  
 ...
 ![ConfigEnabled](images/config_enable.png)  
...
![DevOpsPipeline](images/DevOpsPipeline.png)
